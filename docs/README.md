...
- [api.md](./api.md) — referência completa da API REST: autenticação/RBAC,
  formato de erro, todas as rotas por recurso com request/response e
  enums, extraída diretamente do código-fonte dos controllers.
