...
/// <param name="Type">
/// Categoria do erro (<see cref="ErrorType"/>), usada pela camada HTTP para
/// escolher o código de status correto. Padrão <see cref="ErrorType.Validation"/>.
/// </param>
public sealed record Error(string Code, string Message, [property: JsonIgnore] ErrorType Type = ErrorType.Validation)
{
